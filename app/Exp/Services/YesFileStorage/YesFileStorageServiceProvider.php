...
namespace App\Exp\Services\YesFileStorage;
...
class YesFileStorageServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->singleton('yesfilestorage', function ($app) {
               return new \App\Exp\Services\YesFileStorage\YesFileStorage();
        });
        ...
        $this->app->booting(function () {
            ...
            $loader->alias('YesFileStorage',
                \App\Exp\Services\YesFileStorage\YesFileStorageFacade::class);
        });
    }
}
