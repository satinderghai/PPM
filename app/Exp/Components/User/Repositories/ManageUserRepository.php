...
use App\Exp\Components\User\Models\Faker\{FakerUserModel, FakerUserProfile, FakerUserAuthority};
use DB;
use App\Exp\Components\UserSetting\Models\UserPhotosModel;
use App\Exp\Components\UserSetting\Models\UserSpecificationModel;
...
{ 
    ...
    public function storeUser($storeData)
    {
        ...
        $keyValues = [
            ...
            'status' => array_get($storeData, 'status', 1),
            'username',
