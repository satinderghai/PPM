<?php
    /**
     * Core Helper - 1.6.11 - 27 APR 2020.
     * 
    ...
    Route::get('/state-via-route/{stateRouteInfo}', [
        ...
        'uses'  => 'App\Exp\__Laraware\Support\CommonSupport@stateViaRoute'
    ]);
    ...
    Route::get('/redirect-via-post/{redirectPostData}', [
        ...
        'uses'  => 'App\Exp\__Laraware\Support\CommonSupport@redirectViaPost'
    ]);    
