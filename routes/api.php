...
// its required to accept credentials/cookies from the browser
header("Access-Control-Allow-Credentials: true");
header("Access-Control-Allow-Headers: Authorization, X-Requested-With, X-XSRF-Token, X-CSRF-TOKEN,Content-Type, Api-Request-Signature");
